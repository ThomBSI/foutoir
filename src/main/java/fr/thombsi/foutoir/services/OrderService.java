package fr.thombsi.foutoir.services;
...
public class OrderService extends HttpServlet {
    ...
    public Order initOrder( HttpServletRequest request ) {
        ...
        if ( VALUE_OLD_CUST.equals( request.getParameter( FIELD_RADIO_OLD_CUST ) ) ) {
            ...
            customer = (Customer) sessionMapCustomer.get( lastName );
            ...
            CustomerService formCustomer = new CustomerService();
            customer = formCustomer.initCustomer( request, filesPath );
